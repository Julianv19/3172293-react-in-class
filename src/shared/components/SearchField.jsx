// src/shred/components/SeacrhField.jsx
...
const baseStyles =
    "search flex item-center rounded-xl px-3 transition-all border ";
...
const variantStyles = {
    // Filled: campo con fondo relleno, borde minimo o sutil (Material "Filled TextField").

    filled:
        "bg-neutral-100 border-blue-500 hover:border-blue-700 focus-within:bg-white",

    // Outline:campo con fondo transparente y borde visible siempre.
        ...
        return(
            <form
                ...
                className= {clsx(
                    ...
                    error
                        ? "border-red-500 focus-widthin:ring-2 focus-within:ring-red-500"
